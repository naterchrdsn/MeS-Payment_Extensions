...
<table width="100%" cellpadding="3" cellspacing="10" border="0">
	...
	<tr>
  	...
  	<tr>
		...
		<td><input type="text" name="card_number" value="" size="16" maxlength="16" /></td>
  	</tr>
    <tr>
  	...
  	<tr>
		...
		<td><input type="text" name="cvv2" value="" size="5" maxlength="4" class="textbox_small" style="text-align: center" />
