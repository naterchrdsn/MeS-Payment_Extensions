...
$_['help_ach_review']         = 'Status for transactions declined due to Fraud Services settings';
$_['help_ach_merch_id']       = 'IMPORTANT NOTE:<br />If MeS gave you a Merchant ID, you must enter that number here.<br />(If no number is entered, Fraud Services will not be activated for your transactions.)';
