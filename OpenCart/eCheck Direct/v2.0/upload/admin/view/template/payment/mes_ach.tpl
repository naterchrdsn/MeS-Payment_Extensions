        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-mes" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-extras">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="mes_ach_merch_id"><span data-toggle="tooltip" title="<?php echo $help_ach_merch_id; ?>"><?php echo $entry_merch_id; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="mes_ach_merch_id" value="<?php echo $mes_ach_merch_id; ?>" placeholder="<?php echo $entry_merch_id; ?>" id="mes_ach_merch_id" class="form-control"/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_ach_review; ?>"><?php echo $entry_review_status; ?></label>
                <div class="col-sm-10">
                  <select name="mes_ach_review_status_id" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $mes_ach_review_status_id) { ?>
