...
class ControllerPaymentMes extends Controller {
	...
	public function index() {
		...
		$data['help_merch_id'] = $this->language->get('help_merch_id');
		...
		if (isset($this->request->post['mes_review_status_id'])) {
			$data['mes_review_status_id'] = $this->request->post['mes_review_status_id'];
		} else {
			$data['mes_review_status_id'] = $this->config->get('mes_review_status_id');
		}
		...
		if (isset($this->request->post['mes_merch_id'])) {
			$data['mes_merch_id'] = $this->request->post['mes_merch_id'];
		} else {
			$data['mes_merch_id'] = $this->config->get('mes_merch_id'); 
		} 
