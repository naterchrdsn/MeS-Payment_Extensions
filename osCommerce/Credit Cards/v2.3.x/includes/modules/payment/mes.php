    ...
    function process_button() {
      if (MODULE_PAYMENT_MES_PAYMENT_MODE == 'PayHere') {
        ...
        if ( MODULE_PAYMENT_MES_TEST_MODE !== 'Live' ) {
            $process_button_string .= tep_draw_hidden_field('use_simulator', 'Y');
        }
        ...
        $process_button_string .= tep_draw_hidden_field('client_reference_number', $this->getClientReferenceNumber());
