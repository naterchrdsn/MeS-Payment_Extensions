 ...
 *
 * @copyright Copyright 2011 Merchant e-Solutions
...
class mes {
    ...
    function mes() {
      ...
      $this->signature = 'mes|mes|1.1|1.2';
    ...
    function keys() {
      return array(	'MODULE_PAYMENT_MES_STATUS', 
					'MODULE_PAYMENT_MES_LOGIN_ID', 
					'MODULE_PAYMENT_MES_TRANSACTION_KEY', 
					'MODULE_PAYMENT_MES_TRANSACTION_SERVER', 
