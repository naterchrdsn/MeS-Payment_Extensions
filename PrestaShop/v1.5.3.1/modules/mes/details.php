...
<form action="process.php" id="mes_payment" method="post">
	<fieldset>
			...
			<tr>
				<td colspan="2">
					...
					<p class="cart_navigation">
						...
						<input type="submit" id="mes_confirm" name="submitPayment" class="exclusive_large" />
					</p>
				</td>
			</tr>
		</table>
...
<script type="text/javascript"><!--
	...
	$('#mes_confirm').bind('click', function() {
		if(free) {
			free = false;
			document.getElementById('mes_confirm').disabled = true;
			document.getElementById('mes_payment').submit();
		}
	});
//--></script>
</p>